...
public class OfficeAssignmentService {
    ...
    public Office assignOffice(String description, String location, List<String> tags) {
        try {
            // Create a prompt that includes all office descriptions
            ...
            String prompt = String.format(
                    "Based on this incident description: '%s', location: '%s', and tags: '%s', " +
                            "determine the most appropriate office to handle this incident from the following options:\n\n%s\n\n"
                            +
                            "Return ONLY the office code (e.g., HR, FO, MIS, etc.) that best matches the incident. " +
            ...
            generationConfig.put("temperature", 0.3); // Lower temperature for more consistent results
            ...
            if (body == null || !body.containsKey("candidates")) {
                ...
                return Office.SSO; // Default to Office of the President if there's an error
            }
