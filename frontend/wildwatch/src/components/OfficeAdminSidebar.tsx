      ...
      >
        ...
        >
          <div className="relative">
            ...
            <div className="relative">
              {collapsed && !isMobile ? (
                <div className="mt-2 w-10 h-10 bg-white rounded-full flex items-center justify-center">
        ...
        <nav
          ...
          } pt-2 pb-4 overflow-y-auto hide-scrollbar`}
        >
            ...
            <div className="flex items-center justify-between">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <div className="w-10 h-10 rounded-full bg-[#D4AF37]/20 text-[#D4AF37] flex items-center justify-center font-medium relative group-hover:ring-2 group-hover:ring-[#D4AF37]/50">
                      {getInitials(user.firstName, user.lastName)}
