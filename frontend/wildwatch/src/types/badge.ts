/**
 * Types and interfaces for the badge system
 */

export type BadgeType = 'FIRST_RESPONDER' | 'COMMUNITY_HELPER' | 'CAMPUS_LEGEND' | 'FIRST_RESPONSE' | 'RATING_CHAMPION' | 'OFFICE_LEGEND';
...
// Badge icons (will be replaced with actual icons)
