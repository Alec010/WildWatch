...
export default function OfficeAdminLeaderboardPage() {
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          <span>{entry.totalRatings} ratings</span>
          <span>•</span>
          <span>{entry.averageRating.toFixed(1)} avg rating</span>
        </div>
      </div>
        ...
        <div className="max-w-6xl w-full mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-[#800000]">Office Admin Leaderboard</h1>
            </div>
            <button
