...
export default function TermsPage() {
  ...
  const handleAcceptTerms = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "Failed to accept terms")
  ...
  const sections = [
      ...
      content: (
        <>
          <p className="mb-4 mt-3 text-foreground">
            ...
            incidents within CITU. Use of this platform must be in accordance with university policies, applicable laws,
            and ethical conduct.
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>You must be a currently enrolled student or an authorized CITU personnel to use the platform.</li>
            <li>
              You agree to provide accurate, truthful, and complete information when submitting a report or using any
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-4 mt-3 text-foreground">As a user of WildWatch, you agree:</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>Not to impersonate others or use false identities.</li>
            <li>
              Not to upload, share, or distribute content that is harmful, obscene, threatening, discriminatory, or
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc pl-6 mb-4 mt-3 space-y-2">
          <li>
            CITU and the WildWatch team are not responsible for delays in action due to incomplete, false, or
            unverifiable reports.
          </li>
          <li>
            The platform is provided on an "as-is" basis. While we strive for accuracy and promptness, we do not
            guarantee uninterrupted or error-free operations.
          </li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <p className="mb-4 mt-3 text-foreground">
          These Terms may be updated at any time. Continued use of the Platform after changes are posted constitutes
    ...
    },
    {
      ...
      content: (
        <p className="mb-4 mt-3 text-foreground">
          For questions or concerns regarding these Terms or your use of the Platform, you may contact the WildWatch
          Support Team via the official CITU Office of Student Affairs.
        </p>
      ),
    },
  ]
    ...
    <div className="min-h-screen bg-[#f5f5f7] flex flex-col">
          ...
          <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-[#D4AF37]/20 relative">
            ...
            <div className="p-8 border-b border-[#D4AF37]/30 relative">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-bold text-[#800000]">Terms and Conditions</h1>
              </div>
              <p className="text-muted-foreground ml-6">Effective Date: April 08, 2025</p>

              <div className="mt-6 p-5 bg-[#FFF8E1] border-l-4 border-[#D4AF37] rounded-md">
                <p className="text-foreground leading-relaxed">
                  Welcome to WildWatch, the official incident reporting and case management platform of Cebu Institute
                  of Technology – University (CITU). By accessing or using the WildWatch website and application (the
                  "Platform"), you agree to comply with and be bound by the following Terms and Conditions. Please read
                  them carefully.
                </p>
              </div>
            </div>
            ...
            {/* Accordion sections */}
            <div className="p-6 md:p-8 space-y-4 max-h-full">
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`p-2 rounded-full ${
                          activeSection === index ? "bg-[#800000]/10" : "bg-[#D4AF37]/10"
                        }`}
                      >
                        {section.icon}
                      </div>
                      <span
                        className={`text-lg ${
                          activeSection === index ? "text-[#800000] font-semibold" : "text-foreground"
                        }`}
                      >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${
                      activeSection === index ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                    }`}
                  >
                    <div className="p-4 pt-0 border-t border-[#D4AF37]/20">{section.content}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div className="bg-white py-4 border-t border-[#D4AF37]/20 mt-auto">
        <div className="max-w-[1200px] mx-auto px-4 text-center text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} WildWatch - Cebu Institute of Technology – University. All rights reserved.
        </div>
      </div>
    </div>
  )
