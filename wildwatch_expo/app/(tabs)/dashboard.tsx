...
function getStatusInfo(status?: string | null) {
  ...
  if (normalized.includes("in progress"))
    return { color: "#1976D2", text: "In Progress", icon: "time" as const };
  ...
  if (normalized.includes("urgent"))
    return { color: "#F44336", text: "Urgent", icon: "warning" as const };
    ...
    >
      <View className="items-start">
        <View
          ...
          style={{ width: 24, height: 24, backgroundColor: `${iconTint}20` }}
        >
        ...
        <Text
          className={`${isActive ? "text-gray-700" : "text-gray-600"}`}
          style={{ fontSize: 10 }}
        >
          {title}
        </Text>
          ...
          >
            ...
            {hasUnread ? (
              <View
                ...
                style={{ top: -2, right: -2, width: 12, height: 12 }}
              />
            ) : null}
          </TouchableOpacity>
          {/* Profile */}
      ...
      >
        ...
        >
          <View className="flex-row justify-between items-center mb-3">
            <Text className="font-bold text-[#8B0000]" style={{ fontSize: 18 }}>
              Overview
            </Text>
            {activeFilter && (
              <TouchableOpacity
        ...
        {/* My Incidents Header */}
        <View
          className="bg-white flex-row mb-4 rounded-lg"
          style={{
            shadowColor: "#000",
            shadowOffset: { width: 0, height: 1 },
            shadowOpacity: 0.06,
        ...
        >
          <View className="flex-1 items-center" style={{ paddingVertical: 16 }}>
            <View className="flex-row items-center justify-center">
              ...
              <Text className="ml-2 font-medium text-[#8B0000]">
                My Incident Reports
              </Text>
            </View>
          </View>
