...
export default function ReportScreen() {
  ...
  useEffect(() => {
    if (params.latitude && params.longitude) {
      ...
      console.log("Location data updated successfully in form state");
  ...
  const handleSuccessModalClose = async () => {
    ...
    // Clear evidence files from storage after successful submission
                  ...
                  >
                    ...
                    <View style={{ flex: 1, marginLeft: 8 }}>
                      ...
                      <Text
                        style={{
                          color:
                            form.withinCampus === false ? "#7F1D1D" : "#14532D",
                          fontSize: fontSize - 2,
                          fontWeight: "500",
                        }}
                        numberOfLines={2}
                  ...
                  {form.tags.length > 0 && (
                    ...
                    >
                      ...
                      >
                        ...
                        <TouchableOpacity
                          ...
                          style={{
                            ...
                            flexDirection: "row",
                            alignItems: "center",
                            shadowColor: isGeneratingTags ? "#000" : "#EAB308",
                            shadowOffset: { width: 0, height: 1 },
                            shadowOpacity: isGeneratingTags ? 0.1 : 0.2,
                            shadowRadius: 2,
                            elevation: 2,
                      ...
                      >
                        ...
                        {/* Tags Count - Bottom Right Corner */}
                        <View
                          style={{
                            position: "absolute",
                            bottom: 0,
                ...
                <View style={{ marginBottom: margin }}>
                  ...
                  {witnesses.length > 0 ? (
                    ...
                    >
                      ...
                      >
                        If anyone witnessed the incident, add their information
            ...
            <>
              ...
              >
                ...
                <View style={{ marginBottom: margin }}>
                  ...
                  >
                    <Text style={{ fontWeight: "600", fontSize: fontSize - 2 }}>
                      Incident Type:
                    </Text>
                    ...
                    >
                      <Text
                        style={{
                          ...
                          marginRight: 8,
                          color:
                            form.withinCampus === false ? "#DC2626" : "#374151",
                        }}
                      >
                        Location:
                      </Text>
                      <View
                        style={{
                          backgroundColor:
                            form.withinCampus === false ? "#FECACA" : "#DCFCE7",
                          paddingHorizontal: 8,
                          paddingVertical: 4,
                          borderRadius: 12,
                        }}
                    ...
                    {form.buildingName && (
                      <Text
                        style={{
                          ...
                          marginTop: 2,
                          color:
                            form.withinCampus === false ? "#991B1B" : "#6B7280",
                          fontWeight: "500",
                        }}
                      >
                        Building: {form.buildingName}{" "}
                ...
                <View style={{ marginBottom: margin }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        personnel. You will receive a confirmation email with a
                        tracking number once your report is submitted.
                      </Text>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    >
                      ...
                      the public. This is just a preference and may be reviewed
                      by the admin.
                    </Text>
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  // ------ Header ------
  headerWrap: {
    backgroundColor: "#7A0000", // maroonDark
